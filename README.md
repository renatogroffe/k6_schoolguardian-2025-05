...
Tecnologias e tópicos abordados: **k6, Load Tests, Performance Tests, JavaScript, Docker, Docker Hub, Azure Container Apps, Application Insights, Azure Monitor, Log Analytics, Azure DevOps, Azure Pipelines, Linux, Git, PostgreSQL, MySQL, .NET, ASP.NET Core, JWT, Go...**
